package com.equalize.controller.common;

import com.equalize.controller.organizer.*;
import com.equalize.controller.participant.RoleGameSkillController;

import com.equalize.controller.participant.ParticipantCompleteController;

import com.equalize.config.AppConfig;
import com.equalize.controller.participant.ParticipantLoginController;
import com.equalize.controller.participant.SurveyController;
...
public class RootLayoutController {
    ...
    public void showParticipantLogin() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
                    "/com/equalize/fxml/participant/participant_login.fxml"));
    ...
    public void showParticipantSurvey() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/com/equalize/fxml/participant/participant_survey.fxml"));
    ...
    public void showParticipantRoleGameSkill() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
                    "/com/equalize/fxml/participant/participant_role_game_skill.fxml"));
            Node view = loader.load();
    ...
    public void showParticipantComplete() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
                    "/com/equalize/fxml/participant/participant_complete.fxml"));
            Node view = loader.load();
    ...
    public void showOrganizerDashboard() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
                    "/com/equalize/fxml/organizer/organizer_dashboard.fxml"));
            Node view = loader.load();
    ...
    public void showOrganizerDataSource() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
                    "/com/equalize/fxml/organizer/organizer_data_source.fxml"));
            Node view = loader.load();
    ...
    public void showOrganizerInvalidRows() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
                    "/com/equalize/fxml/organizer/organizer_invalid_rows.fxml"));
            Node view = loader.load();
    ...
    public void showOrganizerTeamFormation() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
                    "/com/equalize/fxml/organizer/organizer_team_formation.fxml"));
            Node view = loader.load();
    ...
    public void showOrganizerViewTeams() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
                    "/com/equalize/fxml/organizer/organizer_view_teams.fxml"));
            Node view = loader.load();
